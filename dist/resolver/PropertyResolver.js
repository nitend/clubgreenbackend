...
let PropertyResolver = class PropertyResolver {
    ...
    getNewProperty() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.insert(new Property_1.Property());
        });
    }
    getAllProperties() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateProperty(property) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.replace(property);
        });
    }
    deleteProperty(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    insertProperty(property) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.insert(property);
        });
    }
};
__decorate([
    type_graphql_1.Query(() => Property_1.Property, { nullable: true }),
...
__decorate([
    type_graphql_1.Query(() => Property_1.Property),
    type_graphql_1.UseMiddleware(isAuthMiddleware_1.isAuth),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PropertyResolver.prototype, "getNewProperty", null);
__decorate([
    type_graphql_1.Query(() => [Property_1.Property], { nullable: true }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PropertyResolver.prototype, "getAllProperties", null);
__decorate([
    type_graphql_1.Mutation(() => Boolean),
    type_graphql_1.UseMiddleware(isAuthMiddleware_1.isAuth),
    __param(0, type_graphql_1.Arg("property")),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PropertyResolver.prototype, "deleteProperty", null);
__decorate([
    type_graphql_1.Mutation(() => Boolean),
    type_graphql_1.UseMiddleware(isAuthMiddleware_1.isAuth),
    __param(0, type_graphql_1.Arg("property")),
    ...
    __metadata("design:paramtypes", [Property_1.Property]),
    __metadata("design:returntype", Promise)
], PropertyResolver.prototype, "insertProperty", null);
